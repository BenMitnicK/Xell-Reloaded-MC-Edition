...
#define KV_FLASH_SIZE             xenon_get_kv_size2()
#define KV_FLASH_OFFSET			  xenon_get_kv_offset2()
...
/*static const unsigned int xelloffsets2[XELL_OFFSET_COUNT] = {0x70000, // ggBoot main xell-gggggg
...
//int xenon_get_console_type2(void);
